...
const getById = "SELECT b.id, b.title, b.description, b.number_of_pages, l.name AS language_name, l.id AS language_id, b.number_of_likes FROM books b JOIN languages l ON b.language_id = l.id WHERE b.id= $1;"
